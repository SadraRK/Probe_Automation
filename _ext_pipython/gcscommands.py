...
class GCSCommands(object):
    ...
    def __init__(self, msgs):
        ...
        @param msgs : An instance of a _ext_pipython.gcsmessages object.
        """
    ...
    def checkerror(self):
        ...
        error = self.qERR()
        if error:
            raise _ext_pipython.GCSError(error)
    ...
    def getparam(self, param, item=1):
        ...
        except _ext_pipython.GCSError as exc:
            if exc in (_ext_pipython.gcserror.E54_PI_CNTR_UNKNOWN_PARAMETER,
                       _ext_pipython.gcserror.E1_PI_CNTR_PARAM_SYNTAX,
                       _ext_pipython.gcserror.E_7_COM_TIMEOUT,
                       _ext_pipython.gcserror.E_1020_PI_INVALID_SPA_CMD_ID):
                return None
            else:
                raise
        return value
    ...
    def qERR(self):
        ...
        try:
            ...
            raise _ext_pipython.GCSError(_ext_pipython.gcserror.E_1004_PI_UNEXPECTED_RESPONSE, answer)
